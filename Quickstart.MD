...
This guide shows how to host OpenControls in a game loop. OpenControls does not provide a renderer, so you implement `IUiRenderer` in your host (MonoGame, SDL, etc).
