...
- Custom TTF/OTF/WOFF2 font loading, merged icon-font support, and optional HarfBuzz-backed shaping are tracked in the parity roadmap; today the shipped path is still `TinyBitmapFont`-based.
