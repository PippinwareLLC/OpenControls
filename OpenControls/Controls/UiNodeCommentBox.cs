...
public sealed class UiNodeCommentBox : UiElement
{
    ...
    private void UpdateLayout(UiFont font)
    {
        ...
        UiRect titleBounds = titleClipBounds.Width <= 0 || titleClipBounds.Height <= 0
            ...
            : new UiRect(
                titleClipBounds.X,
                UiRenderHelpers.GetVerticallyCenteredTextY(titleClipBounds, Title, scale, font),
                Math.Min(titleClipBounds.Width, font.MeasureTextWidth(Title, scale)),
                textHeight);
        ...
        UiRect[] lineBounds = BuildBodyLineBounds(Text, bodyBounds, font, scale, textHeight, Math.Max(3, padding / 4));
    ...
    private void DrawTitle(UiRenderContext context, UiFont font)
    {
        ...
        string drawText = UiRenderHelpers.BuildElidedText(Title, _debugLayout.TitleBounds.Width, TextScale, font);
    ...
    private void DrawBodyText(UiRenderContext context, UiFont font)
    {
        ...
        string[] lines = WrapLines(Text, _debugLayout.BodyBounds.Width, font, TextScale, _debugLayout.BodyLineBounds.Count);
