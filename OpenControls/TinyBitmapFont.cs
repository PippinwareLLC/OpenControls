...
public sealed class TinyBitmapFont
{
    ...
    private static readonly Dictionary<char, byte[]> BaseGlyphs = new()
    {
        ...
        // Descender letters raise their bowls one row so the tail fits
        // the 7-row cell (the classic tiny-LCD-font treatment) - the old
        // 'g' ended in a single floating pixel that read as clipped.
        ...
        ['p'] = new byte[] { 0b00000, 0b11110, 0b10001, 0b10001, 0b11110, 0b10000, 0b10000 },
        ['q'] = new byte[] { 0b00000, 0b01111, 0b10001, 0b10001, 0b01111, 0b00001, 0b00001 },
        ...
        ['y'] = new byte[] { 0b00000, 0b10001, 0b10001, 0b10001, 0b01111, 0b00001, 0b01110 },
    ...
    {
        ['\u00DF'] = G(0b01110, 0b10001, 0b10110, 0b10001, 0b10001, 0b10110, 0b10000), // sharp s
        ['\u20AC'] = G(0b00110, 0b01001, 0b11100, 0b01000, 0b11100, 0b01001, 0b00110), // euro
        ['\u20BA'] = G(0b01000, 0b01001, 0b01110, 0b01001, 0b01110, 0b01000, 0b00111), // turkish lira
        ['\u0153'] = G(0b00000, 0b00000, 0b01010, 0b10101, 0b10111, 0b10100, 0b01011), // oe
