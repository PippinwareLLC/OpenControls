...
This guide shows how to host OpenControls in a game loop. OpenControls does not provide a renderer, so you implement `IUiRenderer` in your host (MonoGame, etc).
...
- Run `dotnet run --project OpenControls.Examples` to launch the MonoGame examples app.
